...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    key: "render",
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h1", null, "Adopt Me"), _react.default.createElement("div", null, this.state.map(function (pet) {
        var breed;
